...
# should regularly be checked and updated with date and time to remain consistant.
#if no date and time of last investigation, assume that very thorough investigation must be done. 
...
** current models have been assessed and evaluated. Don not alter unless told to do so. 4/12/2026
...
## Tier assignments (must match `stem_service/mdx_onnx.py`) investigate and update. as of 4/12/2026 this has not been updated with latest changes. mdx23c is no longer used. 
...
## How to update after a new matrix run. this should be updated if this statement is still present. when updated use current date and time alway to ensure latest updates are used first. 4/12/2026.
...
### Eligibility snapshot (2026-03-22) — vocal (blended era)as of 4/12/2026, the only 2stem models that are allowed to be useed are those that have tested at 9 or above unless otherwise stated, upon which this statement should be updated with date and time. 
