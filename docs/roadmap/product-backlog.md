# Product backlog (UI / UX)

**Previously:** `docs/new_features.md` (moved here for roadmap grouping).  

**Audience:** Maintainer planning only — web users do not see this file. Status tables were last audited **2026-03-17**; before scheduling work, re-check the codebase.

---

## Overview (historical UX report framing)
...
| ------------------------------------- | ------------------------------------------------------------------- | ----------------------------------------------------------- |
| **Monolithic Page**                   | Everything is on a single scrolling page (very large `App.tsx`; order ~1k+ lines — check repo) | Users may feel overwhelmed; hard to focus on current task   |
