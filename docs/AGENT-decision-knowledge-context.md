...
# AGENT DECISION KNOWLEDGE CONTEXT
# ============================================================
...
goal:
  description: >
    Enable intelligent agent routing, model selection, chaining,
    and mastering-safe decisions for a stem splitter / mixer /
...
# ------------------------------------------------------------
# 4. MODEL REGISTRY (IMPLEMENTATIONS, NOT DECISION DRIVERS)
# ------------------------------------------------------------
models:
  bs_roformer_2025_07:
    supports:
...
# ------------------------------------------------------------
# 5. PIPELINE DEFINITIONS (WHAT MAKES THE APP SMART)
# ------------------------------------------------------------
pipelines:
