...
4. **Product table (tracked):** refresh **`docs/benchmarks/ranked_practical_time_score.csv`** by hand or script from scores + elapsed — see **`docs/MODEL-SELECTION-AUTHORITY.md`**.
