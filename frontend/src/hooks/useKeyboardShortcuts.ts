...
export const KEYBOARD_SHORTCUTS: { key: string; modifier?: string; action: ShortcutAction; label: string; description: string }[] = [
  ...
  { key: "s", action: "soloToggle", label: "S", description: "Solo active stem (mutes others)" },
  { key: "l", action: "loopToggle", label: "L", description: "Toggle loop playback" },
  { key: "e", modifier: "meta", action: "export", label: "Cmd/Ctrl + E", description: "Open export options" },
  { key: "e", modifier: "ctrl", action: "export", label: "Cmd/Ctrl + E", description: "Open export options" },
  ...
  { key: "[", action: "trimStartLeft", label: "[", description: "Nudge trim start earlier" },
  { key: "]", action: "trimStartRight", label: "]", description: "Nudge trim start later" },
  { key: "Shift+[", action: "trimEndLeft", label: "Shift + [", description: "Nudge trim end earlier" },
  { key: "Shift+]", action: "trimEndRight", label: "Shift + ]", description: "Nudge trim end later" },
  { key: "?", action: "help", label: "?", description: "Show keyboard shortcuts" },
  { key: "Enter", modifier: "ctrl", action: "triggerSplit", label: "Ctrl + Enter", description: "Start splitting" },
  { key: "Enter", modifier: "meta", action: "triggerSplit", label: "Cmd + Enter", description: "Start splitting" },
  ...
  { key: "6", modifier: "alt", action: "navBeats", label: "Alt + 6", description: "Go to Beat Maker" },
  { key: "7", modifier: "alt", action: "navTuner", label: "Alt + 7", description: "Go to Guitar Tuner" },
];
