import { Undo2, Redo2, Mic2, Music } from "lucide-react";
  ...
  return (
    <>
      ...
      <nav
        ...
        className="flex w-full max-w-full items-center gap-2xs self-stretch overflow-x-auto rounded-xl border border-border bg-muted/30 p-2xs sm:inline-flex sm:w-fit sm:self-start [-webkit-overflow-scrolling:touch] [scrollbar-width:thin]"
      >
        <button
          type="button"
      ...
      <header
        className={cn(
          "flex flex-col gap-lg rounded-2xl border border-border bg-muted/20 px-md py-md sm:px-lg sm:py-lg lg:flex-row lg:items-center lg:justify-between lg:px-xl",
          "header-sticky",
