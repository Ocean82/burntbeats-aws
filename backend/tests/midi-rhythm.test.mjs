...
const STYLES_RESPONSE = {
  styles: [{ name: "rock", default_tempo: 120 }],
  variations: ["fill"],
};
...
test("GET /api/midi/rhythm/styles proxies groove list", async () => {
  const res = await request.get("/api/midi/rhythm/styles").expect(200);
  assert.deepEqual(res.body, STYLES_RESPONSE);
});

test("POST /api/midi/rhythm/generate/json proxies rhythm payload", async () => {
