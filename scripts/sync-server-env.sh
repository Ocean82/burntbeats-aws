...
append_if_missing backend/.env EMAIL_NOTIFICATIONS_ENABLED "# EMAIL_NOTIFICATIONS_ENABLED=true"
append_if_missing backend/.env EMAIL_HOST "# EMAIL_HOST=smtp.ionos.com"
append_if_missing backend/.env EMAIL_PORT "# EMAIL_PORT=587"
append_if_missing backend/.env EMAIL_USER "# EMAIL_USER="
append_if_missing backend/.env EMAIL_PASS "# EMAIL_PASS="
append_if_missing backend/.env EMAIL_FROM "# EMAIL_FROM="
append_if_missing backend/.env EMAIL_FROM_NAME "# EMAIL_FROM_NAME=BurntBeats"
append_if_missing backend/.env APP_ORIGIN "# APP_ORIGIN=https://www.burntbeats.com"
append_if_missing backend/.env NOTIFY_ON_ERROR "# NOTIFY_ON_ERROR=true"
append_if_missing backend/.env EMAIL_TLS_REJECT_UNAUTHORIZED "# EMAIL_TLS_REJECT_UNAUTHORIZED=true"
append_if_missing backend/.env EMAIL_REPLY_TO "# EMAIL_REPLY_TO="
